...
@section('content')
    <div class="bg-white p-6 rounded-2xl shadow max-w-xl mx-auto">
        <div class="flex items-center mb-6">
            ...
            <h3 class="text-xl font-semibold text-gray-800">Edit Plant</h3>
        </div>

        <form method="POST" action="{{ route('master-plant.update', $plant->plant_code) }}" class="space-y-5">
            @csrf
            @method('PUT')

            <div>
                <label for="plant_code" class="block text-sm font-medium text-gray-700">Kode</label>
                <div class="relative">
                    ...
                    <input type="text" name="plant_code" id="plant_code"
                        class="form-input w-full pl-10 border-gray-300 rounded-lg px-4 py-2 bg-gray-10"
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="plant_name" id="plant_name"
                        ...
                        placeholder="Contoh: Business Unit A" value="{{ $plant->plant_name }}" required>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <select name="isactive" id="isactive"
                        ...
                        <option value="T" {{ $plant->isactive == 'T' ? 'selected' : '' }}>Aktif</option>
                        <option value="F" {{ $plant->isactive == 'F' ? 'selected' : '' }}>Tidak Aktif</option>
                    </select>
                </div>
            </div>

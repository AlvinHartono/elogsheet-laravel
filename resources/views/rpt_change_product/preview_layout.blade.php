...
@section('page_title', 'Change Product Checklist - Layout Preview')
            ...
            <tbody>
                <tr class="align-top">
                    ...
                    <td class="w-3/5 text-center pt-2">
                        <h3 class="text-xl font-bold uppercase">CHANGE PRODUCT <br>CHECKLIST</h3>
                    </td>
                    ...
                    <td class="w-1/5">
                        ...
                        <div class="text-xs leading-tight text-left border border-gray-400 p-2 rounded-md">
                            ...
                            <div><strong>Date Issued</strong> :
                                {{ $header->form_date_issued ? \Carbon\Carbon::parse($header->form_date_issued)->format('ymd') : '240101' }}
                            </div>
                            <div><strong>Revision</strong> : {{ $header->form_revision ?? '00' }}</div>
                            <div><strong>Rev. Date</strong> :
                                {{ $header->form_rev_date ? \Carbon\Carbon::parse($header->form_rev_date)->format('ymd') : '240101' }}
                            </div>
                        </div>
                    </td>
                </tr>
                    ...
                    <tr class="align-top">
                        ...
                        <td class="w-1/2 pl-2">
                            <div class="flex mb-1">
                                ...
                                {{ $header->firstProduct->raw_material ?? 'N/A' }}
                            </div>
                            <div class="flex mb-1">
                                <strong class="w-28">Next Product</strong>:
                                {{ $header->nextProduct->raw_material ?? 'N/A' }}
                            </div>
                            <div class="flex mb-1">

    ...
    <div class="bg-white p-6 rounded shadow-md">
        <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex items-center space-x-3 mb-1">
                    ...
                    <div>
                        ...
                        <div class="text-sm text-gray-600 mt-1">
                            ...
                            <span
                                class="inline-block px-2 py-1 text-xs font-semibold text-purple-800 bg-purple-100 rounded">
                                F/QCO-002
                            </span>
            ...
            <a href="{{ route('report-quality.qc.export.view', ['filter_tanggal' => $tanggal]) }}"
                class="w-full sm:w-auto inline-flex items-center justify-center px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-semibold rounded-lg shadow transition">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor" stroke-width="2">
                    <!-- Ikon badge check -->
        ...
        <form method="GET" action="{{ route('report-quality.qc.index') }}" class="flex flex-wrap items-end gap-4">
            ...
            <div class="flex items-end gap-2">
                ...
                @if (request()->has('filter_tanggal') || request()->has('filter_jam'))
                    <a href="{{ route('report-quality.indexqc') }}"

...
<head>
    <meta charset="UTF-8">
    <title>Change Product Checklist - {{ $header->id }}</title>
    <style>
        body {
            font-size: 10px;
        ...
        <tbody>
            <tr style="vertical-align: top;">
                ...
                <td class="w-3-5 text-center no-border" style="width: 60%; padding-top: 8px;">
                    <h3 class="uppercase" style="font-size: 16px; margin: 0;">CHANGE PRODUCT <br>CHECKLIST</h3>
                </td>
        ...
        <tbody>
            <tr>
                ...
                <td style="width: 50%;">
                    ...
                    {{ $header->firstProduct->raw_material ?? 'N/A' }} <br>
                    <strong>Next Product</strong>:
                    {{ $header->nextProduct->raw_material ?? 'N/A' }} <br>

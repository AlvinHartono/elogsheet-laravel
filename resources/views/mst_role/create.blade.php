...
@section('content')
    <div class="bg-white p-6 rounded-2xl shadow max-w-xl mx-auto">
        <div class="flex items-center mb-6">
            ...
            <h3 class="text-xl font-semibold text-gray-800">Tambah Data Role</h3>
        </div>

        <form action="{{ route('master-role.store') }}" method="POST" class="space-y-5">
            @csrf
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="role_code" id="role_code"
                        ...
                        placeholder="Contoh: MGR" required>
                </div>
            </div>

            <div>
                <label for="role_name" class="block text-sm font-medium text-gray-700">Nama</label>
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" viewBox="0 0 20 20"
                            fill="currentColor">
